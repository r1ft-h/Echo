...
# -----------------------------------------------------------------------------
# Compatible with Ubuntu 22.04 running inside WSL 2 (Windows 10/11).
# * Installs Docker CE + NVIDIA container toolkit inside WSL
# * Creates /opt/shai directory tree and logging infrastructure
...
# ─────────────────── NVIDIA container toolkit for WSL 2 ──────────────────────
...
# ─────────── Add invoking (Windows) user to docker group ─────────────────────
